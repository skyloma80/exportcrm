    ...
    const templateData = [
      {
        ...
        "Rating": "5",
        "Currency": "USD",
        "Address (EN)": "123 Main St, New York, NY 10001",
        "Address (CN)": "",
      ...
      <DialogContent className="sm:max-w-[500px]">
        ...
        <div className="space-y-4 py-4">
          ...
          <div className="space-y-2">
            <Label>{t("customers.import.selectFile")}</Label>
            <div
          ...
          <div className="flex items-center space-x-2">
            ...
            <Label htmlFor="updateExisting" className="text-sm">
              {t("customers.import.updateExisting")}
            </Label>
          </div>
            ...
            <Alert variant={result.failed > 0 ? "destructive" : "default"}>
              ...
              <AlertDescription>
                <div className="space-y-1">
                  ...
                  {result.created > 0 && (
                    <p className="text-sm">{t("customers.import.created", { count: String(result.created) })}</p>
                  )}
                  {result.updated > 0 && (
                    <p className="text-sm">{t("customers.import.updated", { count: String(result.updated) })}</p>
                  )}
